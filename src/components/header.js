            ...
            <nav className="navbar">
              ...
              <ul className={menuClassName}>
                ...
                <li className="social-media">
                  <a href="mailto:evahmaldonado@gmail.com">
                ...
                <li className="social-media">
                  <a href="https://www.linkedin.com/in/evamaldonado" target="_blank" rel="noopener noreferrer">
                ...
                <li className="social-media">
                  <a href="https://twitter.com/journalism4eva?lang=en" target="_blank" rel="noopener noreferrer">
